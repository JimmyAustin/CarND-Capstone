...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        rospy.logerr("WP: {0}, State:{1}".format(light_wp, state))
        '''
    ...
    def get_light_state(self, light):
        ...
        #Get classification
        rospy.logerr('Running classifier')
    ...
    def process_traffic_lights(self):
        ...
        if closest_traffic_light is None:
            return -1, TrafficLight.UNKNOWN
        waypoint_id, _ = self.find_waypoint_nearest_point(stop_point)
    ...
    def find_waypoint_nearest_point(self, point):
        if (self.waypoint_tree is None):
            return None, None
        result = self.waypoint_tree.query(point)
    ...
    def find_next_stop_point(self, stop_points):
        rospy.logerr('Closest waypoint')
        rospy.logerr(str(self.get_closest_waypoint()))
        closest_waypoint_id, _ = self.get_closest_waypoint()
